...
const friendrequest_1 = require("../../dtos/friendrequest");
const friendrequest_service_1 = require("../../services/friendrequest/friendrequest.service");
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [friendrequest_1.CreateRequestDto]),
    __metadata("design:returntype", Promise)
